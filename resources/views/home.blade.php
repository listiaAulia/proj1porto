...
<head>
    ...
    <title>My Portofolio | listia aulia </title>
...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="#">listia aulia </a>
...
<div class="container-fluid">
  <footer class="py-3 my-3 border-top">
    <p class="text-center">&copy;2023 <a href="" class="fw-bold text-decoration-none">listia aulia</a></p>
  </footer>
</div>
</body>
